...
import io.metersphere.common.constants.JavaConstants;
import io.metersphere.common.constants.SpringConstants;
import io.metersphere.common.model.Value;
import io.metersphere.common.parse.model.Jsr303Info;
import io.metersphere.common.parse.model.TypeParseContext;
import io.metersphere.common.util.parser.InternalUtils;
import io.metersphere.common.util.parser.PsiSwaggerUtils;
import io.metersphere.common.util.psi.*;
...
public class ParseHelper {
    ...
    private String getSummaryFromDescriptionField(PsiMethod psiMethod) {
        String summary = null;
        String[] tags = {DocumentTags.Description, DocumentTags.DescriptionUpload};
        for (String tag : tags) {
