...
import io.metersphere.common.constants.DocumentTags;
import io.metersphere.common.model.ApiSpecification;
import io.metersphere.common.model.BeanCustom;
import io.metersphere.common.model.DataTypes;
import io.metersphere.common.model.Property;
import io.metersphere.common.parse.model.Jsr303Info;
import io.metersphere.common.parse.model.TypeParseContext;
import io.metersphere.common.util.psi.PsiDocCommentUtils;
import io.metersphere.common.util.psi.PsiFieldUtils;
import io.metersphere.common.util.psi.PsiTypeUtils;
import io.metersphere.common.util.psi.PsiUtils;
import io.metersphere.common.util.parser.PsiGenericUtils;
...
public class KernelParser {
    ...
    public KernelParser(Project project, Module module, ApiSpecification settings, boolean isResponse) {
        ...
        this.dataTypeParser = new DataTypeParser(project, module);
    ...
    private Property doParse(TypeParseContext context, PsiType psiType, String canonicalType, Set<PsiClass> chains) {
        ...
        if (PsiTypeUtils.isArray(psiType)) {
            assert psiType instanceof PsiArrayType;
