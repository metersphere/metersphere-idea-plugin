...
public class UploadSettingPaneV3 extends JBPanel<UploadSettingPaneV3> {
    ...
    // 平台配置
    private final UploadSettingStateV3 appSettingService = Objects.requireNonNull(UploadSettingComponent.getInstance().getState()).getUploadSettingStateV3();
    ...
    public UploadSettingPaneV3() {
        ...
        JLabel organizationLabel = new JLabel(Bundle.get("ms.window.tab.organization"));
        ...
        meterSphereAddress.setPreferredSize(new Dimension(320, 32));
        accessKey.setPreferredSize(new Dimension(320, 32));
        secretKey.setPreferredSize(new Dimension(320, 32));
        testCon.setPreferredSize(new Dimension(320, 32)); // Adjust width and height as needed

        // Ensure JComboBox has enough width to display its content
        organizationJComboBox.setPreferredSize(new Dimension(320, 32));
        projectJComboBox.setPreferredSize(new Dimension(320, 32));
        moduleJComboBox.setPreferredSize(new Dimension(320, 32));
        coverModuleJComboBox.setPreferredSize(new Dimension(320, 32));
    ...
    private void initData(UploadSettingStateV3 appSettingService) {
    ...
    private void initProject(UploadSettingStateV3 appSettingService, String organizationId) {
    ...
    private void initCoverModule() {
        List<CoverModule> list = Arrays.asList(
                new CoverModule("override", Bundle.get("ms.upload.message.overwrite")),
                new CoverModule("non-override", Bundle.get("ms.upload.message.non-overwriting"))
        );
